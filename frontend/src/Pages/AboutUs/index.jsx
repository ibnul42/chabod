...
const AboutUs = () => {
  return (
    <div className="px-3">
      ...
      <section className="grid grid-cols-12 gap-3">
        ...
        <div className="col-span-12 md:col-span-8">
          <div className="my-3 flex flex-col gap-4 font-medium">
            ...
            <div className="">
              <p className="font-bold my-2">የአገልግሎቱ ግብ​</p>
              <p>
            ...
            <div className="">
              <p className="font-bold my-2">የአገልግሎቱ ተልዕኮ​</p>
              <p>
      ...
      <section className="font-medium my-5 grid grid-cols-1 md:grid-cols-2">
        <div className="">
          <p className="font-bold my-2">የአገልግሎቱ የጸሎት አቅጣጫዎች</p>
          <ul className="list-item">
            <li className="list-inside list-disc">
              አካሉ ቅድስት የሆነችው ቤተክርስቲያን እንድትታደስ (RESTORE እንድትሆን) እና እንድትገነባ
            </li>
            <li className="list-inside list-disc">
              እንደ አዋጅ ቃል ነጋሪ ወንጌል እንዲስፋፋ (ኢሳ 40)
            </li>
            <li className="list-inside list-disc">
              በትውልዱ ላይ ስላሉ ተግዳሮቶች እንዲሁም ስለ መጨረሻው ዘመን ምልክቶች
            </li>
            <li className="list-inside list-disc">
              አማኞች መስፈርቶቻችን፤ ሚዛናችን፤ አቆጣጠራችን እግዚአብሔር የፈለገበት እንዲሆን
            </li>
            <li className="list-inside list-disc">
              አማኞች ከክርስቶስ ጋር እና የእርስ በርስ ኪዳናዊ ግኑኝነት እንዲታደስ እና እንዲጠነክር
            </li>
            <li className="list-inside list-disc">የጸጋ ስጦታዎች በአካሉ ውስጥ እንዲገለጡ</li>
          </ul>
        </div>
        <div className="">
          <p className="font-bold my-2">የአገልግሎቱ መደበኛ የጸሎት ጊዜዎች</p>
          <ul className="list-item">
            <li className="list-inside list-disc">
              በየሁለት ሳምንት አንድ ጊዜ በቶሮንቶ፤ በኦንታርዮና ካናዳ በኢትዮጵያ እንዲሁም በተለያየ ክፍለ ዓለማት
              ካሉ የጸሎት አባላት ጋር የጸሎት ቀን ይኖራል
            </li>
            <li className="list-inside list-disc">
              ከአጋር የጸሎት ሕብረቶች ጋር የተቀናጀ ጸሎቶች ያካሂዳል
            </li>
            <li className="list-inside list-disc">
              አመታዊ የሁለት/የሶስት ቀናቶች የጸሎት ኮንፈራንስ ያካሂዳል
            </li>
          </ul>
        </div>
      </section>
